...
class CarrierAccountsApi
{
            ...
            switch($statusCode) {
                case 201:
                    if ('\OpenAPI\Client\Model\CarrierAccount' === '\SplFileObject') {
                        ...
                        if ('\OpenAPI\Client\Model\CarrierAccount' !== 'string') {
                            try {
    ...
    public function getCarrierRegistrationStatusWithHttpInfo($carrier, $shippo_api_version = null, string $contentType = self::contentTypes['getCarrierRegistrationStatus'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\CarrierAccountRegistrationStatus' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\CarrierAccountRegistrationStatus' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CarrierAccountRegistrationStatus', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @param  string $state A random string generated by the consuming application and included in the request to prevent CSRF attacks. The consuming application checks that the same value is returned after the user authorizes Shippo. (optional)
     * @param  string $shippo_api_version String used to pick a non-default API version to use (optional)
     ...
     *
     * @param  bool $service_levels Appends the property &#x60;service_levels&#x60; to each returned carrier account (optional)
     * @param  CarriersEnum $carrier Filter the response by the specified carrier (optional)
     * @param  string $account_id Filter the response by the specified carrier account Id (optional)
     * @param  int $page The page number you want to select (optional, default to 1)
     * @param  int $results The number of results to return per page (max 100, default 5) (optional, default to 5)
     * @param  string $shippo_api_version String used to pick a non-default API version to use (optional)
    ...
    public function listCarrierAccountsWithHttpInfo($service_levels = null, $carrier = null, $account_id = null, $page = 1, $results = 5, $shippo_api_version = null, string $contentType = self::contentTypes['listCarrierAccounts'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\CarrierAccountPaginatedList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\CarrierAccountPaginatedList' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CarrierAccountPaginatedList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     *
     * @param  \OpenAPI\Client\Model\RegisterCarrierAccountRequest $register_carrier_account_request Examples. (required)
     * @param  string $shippo_api_version String used to pick a non-default API version to use (optional)
     ...
     * @param  string $carrier_account_id Object ID of the carrier account (required)
     * @param  string $shippo_api_version String used to pick a non-default API version to use (optional)
     * @param  \OpenAPI\Client\Model\CarrierAccountUpdateRequest $carrier_account_update_request Examples. (optional)
